...
#include "CarControllerInterProcessSignalPropagator.h"

CCarControllerInterProcessSignalPropagator::CCarControllerInterProcessSignalPropagator(InterProcessSignalPropogatorType type, QObject *parent, const QString &hostName, quint16 port)
